...
5. **Page ceiling: 50.** Currently ~32.0. Measure with `scripts/verify.py` after any
...
|---|---|---|
| Prose | 4,516 words | 9.4 |
| Code | 371 lines | 7.1 |
| Tables | 463 rows | 15.4 |
| **Total** | | **32.0** |
...
**Complete — 14 modules, ~32.0 pages:**
...
**~18 pages of headroom** against the 50 ceiling.
